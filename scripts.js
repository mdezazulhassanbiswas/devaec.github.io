const root = document.documentElement,
  ...
  let metaThemeClr = document.getElementById("#meta-theme-color"),
  clrAccent = metaThemeClr.content;
  root.style.setProperty('--clr-accent', clrAccent);

  let favicon = document.getElementById("#my-favicon[href]");
  // let favicon = document.getElementById("favicon")[href].innerText;
  console.log(favicon.DOCUMENT_NODE)
  ...
  let progress = setInterval(() => {
    ...
    backGround.animate({
      background : `conic-gradient(var(--clr-accent) ${startValue * 3.6}deg, transparent 0deg)`
